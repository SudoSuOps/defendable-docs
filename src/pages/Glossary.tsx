...
const TERMS = [
  ...
  { term: "Bakery Pack", def: "A pre-baked SwarmCurator dataset · ready to ship from the Claw Bakery shelf · reconciled, Tribunal-graded, manifest-receipted. Four states: FRESH (ready) · ON THE OVEN (current run) · QUEUED (pre-order) · ON-DEMAND (custom)." },
  ...
  { term: "CRE-Atlas 27B", def: "Custom Defendable fine-tune on Gemma 27B base · trained on CRE due-diligence corpora · cap rate / NOI / DSCR / NNN / 1031 fluent. Flagship model for CRE MarketReady workflows." },
  ...
  { term: "SwarmCurator", def: "DefendableCloud Lane 03 · receipted dataset curation pipeline. Two ways to buy: Bakery Packs (ready-baked off the shelf) or custom concierge intake. Output formats: JSONL · Parquet · HF dataset card · LoRA-ready." },
  { term: "SwarmFixer", def: "The Defendable agent refinery · takes AgentBench-flagged patterns and ships actual fixes (prompt patches · tool-use repairs · guardrail additions), then re-runs the bench to prove the lift. Three tiers: Self-serve · Managed · Embedded (90-day Fix-or-Refund)." },
  { term: "SwarmGrant 9B", def: "Custom Defendable fine-tune on Qwen 9B base · trained on federal + foundation grant corpora · SBIR / STTR / NIH / foundation application drafting. Faster + cheaper than the 27B flagship · same domain rigor." },
